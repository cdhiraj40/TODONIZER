    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                NoteInfo noteInfo = new NoteInfo(edtTitle.getText().toString(), edtDescription.getText().toString());
                noteInfo.setId(intent.getIntExtra("id",1));
                if (new NoteHandler(EditNote.this).update(noteInfo)){
