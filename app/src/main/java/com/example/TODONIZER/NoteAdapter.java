...
public class NoteAdapter extends RecyclerView.Adapter<NoteAdapter.NoteHolder> {
    ...
    public NoteAdapter(ArrayList<NoteInfo> arrayList, Context context, ItemClicked itemClicked){
        noteInfos = arrayList;
    ...
    public void onBindViewHolder(@NonNull NoteHolder holder, int position) {
        ...
        holder.title.setText(noteInfos.get(position).getTitle());
        holder.description.setText(noteInfos.get(position).getDescription());
    }
